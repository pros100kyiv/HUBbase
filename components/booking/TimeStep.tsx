      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-4">
          ...
          {!calendarReady || !currentMonth || !monthStart || !monthEnd ? (
            <div className="bg-white/10 dark:bg-white/5 border border-white/20 rounded-candy-sm p-6 text-center text-white/60 text-sm">
                  ...
                  {calendarDays.map((day) => {
                    ...
                    return (
                      <button
                        key={day.toISOString()}
                        onClick={() => {
                          if (!isPastDate && isDayInMonth) {
                            setDate(new Date(day.getTime()))
                          }
                        }}
