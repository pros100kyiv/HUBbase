...
export function AddTaskCard({ onClick }: AddTaskCardProps) {
  return (
    <button
      onClick={onClick}
      className="border-2 border-dashed border-white/20 rounded-xl p-4 md:p-6 w-full h-full flex flex-col items-center justify-center hover:border-white/30 hover:bg-white/5 transition-all card-glass-subtle active:scale-[0.98] min-h-[120px] md:min-h-0"
    >
