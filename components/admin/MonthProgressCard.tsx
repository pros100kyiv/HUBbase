  ...
  return (
    <div className="bg-gray-100 rounded-xl p-6" style={{ boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)' }}>
      ...
      <div className="flex items-start gap-6 mb-4">
        <div>
          <p className="text-xs font-semibold text-gray-500 uppercase mb-2" style={{ letterSpacing: '0.05em' }}>
            OVERVIEW
          </p>
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex-1 px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
          Download Report
        </button>
      </div>
    </div>
