...
export function Navbar() {
  ...
  if (pathname?.startsWith('/dashboard')) {
    return (
      <>
        <nav className="fixed top-0 left-0 md:left-64 right-0 z-50 bg-[#1A1A1A] border-b border-gray-800">
          <div className="px-6">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-3">
                {/* + Create Button */}
                <button className="px-4 py-2 bg-white text-black rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors" style={{ boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.1)' }}>
                  + Create
                </button>
