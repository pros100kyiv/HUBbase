          ...
          <div className="px-6">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center gap-3">
                {/* + Create Button */}
                <button className="px-4 py-2 bg-white text-black rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors" style={{ boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.3)' }}>
                  + Create
                </button>
