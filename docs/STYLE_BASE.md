...
#### Акцентна палітра (усі вкладки)

| Призначення | Tailwind | Опис |
|-------------|----------|------|
| Дохід, вартість, ключові цифри | `text-purple-400` | Суми (грн), кількість візитів, метрики |
| Головна дія (кнопка) | `bg-emerald-600 hover:bg-emerald-500 text-white` | Записати, Додати, Підтвердити, Зберегти, Підключити |
| Дзвінок / інфо | `text-blue-400` | Іконка телефону, дати |
| Запис / календар | `text-green-400` або `text-emerald-400` | Іконка запису, наступний візит |
| Видалити / небезпека | `text-red-400` | Іконка видалення |
| Статус очікує | `text-orange-400` або `bg-amber-500/20 text-amber-400` | Позначка «Очікує» |
| Статус підтверджено | `text-green-400` | Позначка «Підтверджено» |
| Статус виконано | `text-blue-400` | Позначка «Виконано» |
| Другорядний текст | `text-gray-400` | Підписи, підказки |
