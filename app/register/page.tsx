...
function RegisterForm() {
  ...
  return (
    <AuthLayout title="Реєстрація бізнесу">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <Input
            ...
            required
            className={cn(errors.name && 'border-red-500 focus-visible:ring-red-500 focus-visible:border-red-500')}
          />
        ...
        <div>
          ...
          <Input
            ...
            className={cn(errors.slug && 'border-red-500 focus-visible:ring-red-500 focus-visible:border-red-500')}
          />
